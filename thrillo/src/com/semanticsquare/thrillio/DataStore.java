...
bookmark[0][2] = BookmarkManager.getInstance().createWeblink("http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com	unknown", 2003, "Interface vs Abstract Class"); 
bookmark[0][3] = BookmarkManager.getInstance().createWeblink("http://cs.brown.edu/courses/cs161/papers/j-nio-ltr.pdf", "http://cs.brown.eduunknown", 2004, "NIO tutorial by Greg Travis"); 
bookmark[0][4] = BookmarkManager.getInstance().createWeblink("http://tomcat.apache.org/tomcat-6.0-doc/virtual-hosting-howto.html", "http://tomcat.apache.org", 2005, "Virtual Hosting and Tomcat"); 
...
bookmark[2][0] = BookmarkManager.getInstance().createMovie(3001, "The Grapes",MovieGenre.CLASSICS, 1940 ,new String[] {"Henry Fonda", "Jane Darwell"}, new String[] {"John Ford"}, 8.2,"http://www.javaworld.com/Jane Darwell/core-java/taming-tiger--part-2.html");
bookmark[2][1] = BookmarkManager.getInstance().createMovie(3002, "The Grapes of Wrath",MovieGenre.CLASSICS, 1940 ,new String[] {"Henry Fonda", "Jane Darwell"}, new String[] {"John Ford"}, 8.2,"http://www.javaworld.com/Jane Darwell/core-java/taming-tiger--part-2.html");
bookmark[2][2] = BookmarkManager.getInstance().createMovie(3003, "The Grapes of Wrath",MovieGenre.CLASSICS, 1940 ,new String[] {"Henry Fonda", "Jane Darwell"}, new String[] {"John Ford"}, 8.2,"http://www.javaworld.com/Jane Darwell/core-java/taming-tiger--part-2.html");
bookmark[2][3] = BookmarkManager.getInstance().createMovie(3004, "The Big Bang Theory",MovieGenre.DRAMA, 2007 ,new String[] {"Kaley Cuoco", "Kaley Cuoco"}, new String[] {"Kaley Cuoco","Bill Prady"}, 8.7,"http://www.javaworld.com/Kaley Cuoco/core-java/taming-tiger--part-2.html");
bookmark[2][4] = BookmarkManager.getInstance().createMovie(3005, "The Big Bang Theory",MovieGenre.DRAMA, 2007 ,new String[] {"Kaley Cuoco", "Kaley Cuoco"}, new String[] {"Kaley Cuoco","Bill Prady"}, 8.7,"http://www.javaworld.com/Kaley Cuoco/core-java/taming-tiger--part-2.html");
